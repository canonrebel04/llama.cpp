...
class GGUFReader:
    ...
    def __init__(self, path: os.PathLike[str] | str, mode: Literal['r', 'r+', 'c'] = 'r'):
        ...
        # Performance optimization: numpy.memmap introduces overhead on slicing due to
        # __array_finalize__. Using a base ndarray view preserves zero-copy but speeds up slicing.
    ...
    def _get(
        ...
        # Use _fast_data instead of self.data to bypass memmap slicing overhead
