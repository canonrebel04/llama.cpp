...
class GGUFReader:
    ...
    def __init__(self, path: os.PathLike[str] | str, mode: Literal['r', 'r+', 'c'] = 'r'):
        ...
        # Performance optimization: numpy.memmap introduces overhead during repeated array slicing
        # due to __array_finalize__ and __getitem__. Creating an ndarray view bypasses this overhead
        # while preserving zero-copy behavior.
    ...
    def _get(
        ...
        # Performance optimization: use _fast_data (ndarray view) instead of memmap directly to avoid slicing overhead
