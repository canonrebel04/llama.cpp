...
class GGUFReader:
    ...
    def __init__(self, path: os.PathLike[str] | str, mode: Literal['r', 'r+', 'c'] = 'r'):
        ...
        # Performance optimization: numpy.memmap introduces significant overhead during repeated
        # array slicing due to __array_finalize__ and __getitem__. Creating an ndarray view
        # bypasses this class overhead while preserving zero-copy behavior for internal slicing.
