...
class GGUFReader:
    ...
    def __init__(self, path: os.PathLike[str] | str, mode: Literal['r', 'r+', 'c'] = 'r'):
        ...
        # Performance optimization: numpy.memmap introduces overhead during repeated slicing.
        # Creating an ndarray view bypasses this overhead while preserving zero-copy behavior.
