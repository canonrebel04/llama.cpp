...
#define VDR_PQ2_0_Q8_1_MMQ  2  // PQ2_0 group 128: 4 32-element chunks per block
...
static __device__ __forceinline__ float vec_dot_pq2_0_q8_1(const void * __restrict__ vbq,
    ...
    // PQ2_0 group 128: 128 elements, ONE scale, processed as four 32-element chunks
...
#pragma unroll
    ...
    // Apply PQ2_0's single scale and this chunk's Q8_1 scale
    const float d8 = __low2float(bq8_1_chunk->ds);
    return d2 * d8 * sumi;
}
